  ...
  return (
    <div className="grid grid-cols-4 gap-3">
      {actions.map((action, i) => (
        <button
          key={action.label}
          className="group flex flex-col items-center gap-2 rounded-sm border border-border bg-card-gradient p-4 transition-all duration-500 hover:border-gold/20 hover:shadow-gold animate-slide-up xl:gap-3 xl:p-5"
